                ...
                <div class="col-lg-8 content-main" style="display: inline-block">
                    ...
                    <div class="col-md-10" style="padding-left: 40px">
                        ...
                        <form class="form-horizontal" role="form" method="post" style="padding-left: 80px"
                              id="user-login-form" action="user/save">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select style="height: 138px; width: 345px" name="grade" multiple="multiple">
                                        <c:forEach items="${gradeList}" var="item">
                                            <option value="${item.id}">${item.no}--${item.name}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select  name="role" style="height: 38px; width: 345px">
