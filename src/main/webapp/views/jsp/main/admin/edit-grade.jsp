        ...
        <div class="col-lg-8 content-main" style="display: inline-block">
            ...
            <div class="col-md-10" style="padding-left: 40px">
                ...
                <form class="form-horizontal" role="form" method="post" style="padding-left: 80px"
                      id="user-login-form" action="grade/edit">
                    <div class="form-group">
                        <label for="name" class="col-sm-10 control-label">No</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="no" name="no" value="${grade.no}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="university" name="description" value="${grade.description}">
                        </div>
                    </div>
