                ...
                <div class="contex_body">
                    ...
                    <div class="menu" id="topnav">
                        <div id="all_question">
                            <ul class="tabQType" id="divKaoShiT" style>
                                    ...
                                    <ul class="navlist">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);"
                                               onclick="createFreQ('basic-information');return false;">
                                                <i class="iconfont"></i>
                                ...
                                <li>
                                    <a href="javascript:void(0);"
                                       onclick="PDF_launch('addbatchq.aspx?ks=1',840,620);return false;" class="pladd">批量添加</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="content_question">
                        ...
                        <div style="margin-top: 20px; margin-bottom: 30px; width: 80px;">
                            <input class="btn btn-default btn-block btn-primary" style="margin-left: 450px;" id="submit"
...
<div class="xxk_box">
    <div class="xxk_conn hide">
        ...
        <div class="xxk_xzqh_box dxuan ">
            <textarea name="tile" cols="" rows="" class="input_wenbk btwen_text btwen_text_dx"
        ...
        <div class="xxk_xzqh_box panduan">
            <textarea name="title" cols="" rows="" class="input_wenbk btwen_text btwen_text_dx"
                      placeholder="判断题"></textarea>
            <div class="title_itram">
                <div class="kzjxx_iteam">
        ...
        <div class="xxk_xzqh_box duoxuan hide">
            <textarea name="tile" cols="" rows="" class="input_wenbk btwen_text btwen_text_duox"
        ...
        <div class="xxk_xzqh_box tktm hide">
            <textarea name="tile" cols="" rows="" class="input_wenbk btwen_text btwen_text_tk"
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr valign="top">
                        <td width="135">
                            ...
                            <textarea name="tile" cols="" rows="" class="leftbtwen_text"
                        ...
                        <td>
                            ...
                            <div class="title_itram">
                                <div class="kzjxx_iteam">
                                    ...
                                    <label>
                                        <input name="" type="checkbox" value="" class="fxk"> <span>可填空</span></label> <a
